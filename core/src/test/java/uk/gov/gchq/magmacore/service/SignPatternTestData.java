...
public class SignPatternTestData {
    ...
    static RecognizingLanguageCommunity<IRI> community1;
    static RecognizingLanguageCommunity<IRI> community2;
    static Pattern<IRI> pattern1;
    static Pattern<IRI> pattern2;
    static Person<IRI> person1;
    static Person<IRI> person2;
    static StateOfPerson<IRI> stateOfPerson1;
    static StateOfPerson<IRI> stateOfPerson2;
    ...
    static void createSignPattern(final MagmaCoreDatabase db) {
        ...
        community1 = RdfSpatioTemporalExtentServices.createRecognizingLanguageCommunity(community1Iri);
        ...
        community2 = RdfSpatioTemporalExtentServices.createRecognizingLanguageCommunity(community2Iri);
        ...
        final RepresentationByPattern<IRI> repByPattern1 = ClassServices
        ...
        final RepresentationByPattern<IRI> repByPattern2 = ClassServices
        ...
        // Create People
        person1 = RdfSpatioTemporalExtentServices.createPerson(new IRI(TEST_BASE, "person1"));
        person1.addValue(RDFS.RDF_TYPE, HQDM.PERSON);
        person1.addValue(HQDM.MEMBER_OF_KIND, kindOfPersonIri);

        person2 = RdfSpatioTemporalExtentServices.createPerson(new IRI(TEST_BASE, "person2"));
        ...
        stateOfPerson1 = RdfSpatioTemporalExtentServices
        ...
        stateOfPerson2 = RdfSpatioTemporalExtentServices
        ...
        // Create signs
        final Sign<IRI> sign1 = RdfSpatioTemporalExtentServices.createSign(new IRI(TEST_BASE, "sign1"));
        sign1.addValue(RDFS.RDF_TYPE, HQDM.SIGN);
        sign1.addValue(HQDM.MEMBER_OF_, pattern1Iri);
        sign1.addValue(HQDM.VALUE_, "person1");

        final Sign<IRI> sign2 = RdfSpatioTemporalExtentServices.createSign(new IRI(TEST_BASE, "sign2"));
        ...
        final StateOfSign<IRI> stateOfSign1 = RdfSpatioTemporalExtentServices
        ...
        final StateOfSign<IRI> stateOfSign2 = RdfSpatioTemporalExtentServices
