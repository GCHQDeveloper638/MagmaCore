 ...
 */
public class ClassOfInstalledFunctionalSystemComponentImpl<T> extends HqdmObject<T>
        implements ClassOfInstalledFunctionalSystemComponent<T> {
    /**
     ...
     */
    public ClassOfInstalledFunctionalSystemComponentImpl(final T id) {
        super(id);
    }
}
